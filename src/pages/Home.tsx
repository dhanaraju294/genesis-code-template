    ...
    <div className="min-h-screen bg-gradient-blue">
      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-4xl text-center">
          ...
          <div className="mb-16">
            <Card className="bg-white/95 backdrop-blur-sm shadow-elegant border-0 mb-8">
              <CardHeader>
                <CardTitle className="text-2xl text-center">About AIVA</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-muted-foreground text-center mb-8">
                  AIVA empowers organizations by creating seamless connections among team members through intelligent automation, 
                  real-time collaboration, and data-driven insights. We believe in transforming how teams work together efficiently.
                </p>
                
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div>
                    <h3 className="font-semibold text-xl mb-4 text-center">For Team Members</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-xl mb-4 text-center">Why Choose AIVA?</h3>
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Leverage AI for actionable insights and automation.
                        </p>
                      </div>
                    </div>
                  </div>
